...
class TimeCreditController extends BaseController
{
     ...
     * @return RedirectResponse|Response
     */
    public function surveyBeginAction(Request $request, $id)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Trainee__default_homepage');
     ...
     * @return RedirectResponse|Response
     */
    public function surveyBeginPostAction(Request $request, $id)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Trainee__default_homepage');
     ...
     * @return RedirectResponse|Response
     */
    public function surveyEndAction(Request $request, $id)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Trainee__default_homepage');
     ...
     * @return RedirectResponse|Response
     */
    public function surveyEndPostAction(Request $request, $id)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Trainee__default_homepage');
