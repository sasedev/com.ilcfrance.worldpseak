...
class TraineeNotif
{
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TraineeNotif_trainee")
     */
    protected $trainee;
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TraineeNotif_timeCredit")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TraineeNotif_cours")
     */
    protected $cours;
