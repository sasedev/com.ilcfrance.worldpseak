...
class Trainee implements UserInterface, Serializable
{
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_company")
     *      @Assert\NotNull
     */
    protected $company;
     ...
     *      })
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_preferedLocale")
     */
     ...
     *      }
     *      )
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_traineeRoles")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_credits")
     */
    protected $credits;
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_notifications")
     */
     ...
     *      @ORM\OrderBy({"dtCrea"="DESC"})
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Trainee_logs")
     */
    protected $logs;
