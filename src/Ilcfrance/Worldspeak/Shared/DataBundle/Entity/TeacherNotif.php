...
class TeacherNotif
{
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TeacherNotif_teacher")
     */
    protected $teacher;
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TeacherNotif_timeCredit")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_TeacherNotif_cours")
     */
    protected $cours;
