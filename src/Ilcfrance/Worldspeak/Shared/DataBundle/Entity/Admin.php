...
class Admin implements UserInterface, Serializable
{
     ...
     *      })
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Admin_preferedLocale")
     */
     ...
     *      }
     *      )
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Admin_adminRoles")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Admin_logs")
     */
    protected $logs;
