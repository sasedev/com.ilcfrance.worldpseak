...
class Teacher implements UserInterface, Serializable
{
     ...
     *      })
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_preferedLocale")
     */
     ...
     *      }
     *      )
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_teacherRoles")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_availabilities")
     */
     ...
     *      @ORM\OrderBy({"dtStart"="ASC"})
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_courses")
     */
    protected $courses;
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_notifications")
     */
     ...
     *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Teacher_logs")
     */
    protected $logs;
