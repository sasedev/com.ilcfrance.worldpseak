...
class TeacherNotifRepository extends EntityRepository
{
	...
	{
		$qb = $this->createQueryBuilder('tn')->select('count(tn)')->where('tn.teacher = :teacher')->setParameter('teacher', $teacher);
	...
	{
		$qb = $this->createQueryBuilder('tn')->where('tn.teacher = :teacher')->setParameter('teacher', $teacher)->orderBy('tn.dtStart', 'DESC');
	...
	{
		$qb = $this->createQueryBuilder('tn')->select('count(tn)')->where('tn.teacher = :teacher')->andWhere('tn.dtStart <= :dt')->andWhere('tn.status = :status')->andWhere('tn.type != :typeA')->andWhere('tn.type != :typeB')->setParameter('teacher', $teacher)->setParameter('dt', new \DateTime('now'))->setParameter('status', TeacherNotif::PENDING)->setParameter('typeA', TeacherNotif::TYPE_EMAIL_COURS_EDIT)->setParameter('typeB', TeacherNotif::TYPE_EMAIL_TIMECREDIT_EDIT);
	...
	{
		$qb = $this->createQueryBuilder('tn')->where('tn.teacher = :teacher')->andWhere('tn.dtStart <= :dt')->andWhere('tn.status = :status')->andWhere('tn.type != :typeA')->andWhere('tn.type != :typeB')->setParameter('teacher', $teacher)->setParameter('dt', new \DateTime('now'))->setParameter('status', TeacherNotif::PENDING)->setParameter('typeA', TeacherNotif::TYPE_EMAIL_COURS_EDIT)->setParameter('typeB', TeacherNotif::TYPE_EMAIL_TIMECREDIT_EDIT)->orderBy('tn.dtStart', 'DESC');
	...
	{
		$qb = $this->createQueryBuilder('tn')->select('count(tn)')->where('tn.dtStart <= :dt')->andWhere('tn.status = :status')->andWhere('tn.type != :typeA')->andWhere('tn.type != :typeB')->setParameter('dt', new \DateTime('now'))->setParameter('status', TeacherNotif::PENDING)->setParameter('typeA', TeacherNotif::TYPE_TXT_COURS_EDIT)->setParameter('typeB', TeacherNotif::TYPE_TXT_TIMECREDIT_EDIT);
	...
	{
		$qb = $this->createQueryBuilder('tn')->where('tn.dtStart <= :dt')->andWhere('tn.status = :status')->andWhere('tn.type != :typeA')->andWhere('tn.type != :typeB')->setParameter('dt', new \DateTime('now'))->setParameter('status', TeacherNotif::PENDING)->setParameter('typeA', TeacherNotif::TYPE_TXT_COURS_EDIT)->setParameter('typeB', TeacherNotif::TYPE_TXT_TIMECREDIT_EDIT)->orderBy('tn.dtStart', 'ASC');
