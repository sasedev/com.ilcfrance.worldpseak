                ...
                try {
                    if (null != $teacher->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ...
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:teacher.notif.cours.html.twig', $mvars), 'text/html');
                        ...
                        echo "Mail Notif Cours Edit Formateur " . $teacher->getFullname() . " (" . $teacher->getEmail() . ") pour le Cours de " . $notif->getCours()
                            ->getDtStart()
                            ->format('Y-m-d H:i') . " du stagiaire " . $notif->getTimeCredit()
                            ->getTrainee()
                            ->getFullname() . "\n";
                    } else {
                ...
                try {
                    if (null != $teacher->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ->setTo($teacher->getEmail(), $teacher->getFullname())
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:teacher.notif.timeCredit.html.twig', $mvars), 'text/html');
                        ...
                        echo "Mail Notif TimeCredit Edit Formateur " . $teacher->getFullname() . " (" . $teacher->getEmail() . ") pour le Credit de " . $notif->getTimeCredit()->getTotalHours() . " Heures du stagiaire " . $notif->getTimeCredit()
                            ->getTrainee()
                            ->getFullname() . "\n";
                    } else {
                ...
                try {
                    if (null != $trainee->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ...
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:trainee.notif.cours24h.html.twig', $mvars), 'text/html');
                        ...
                        echo "Mail Notif Cours 24H Stagiaire " . $trainee->getFullname() . " (" . $trainee->getEmail() . ") pour le Cours de " . $notif->getCours()
                            ->getDtStart()
                            ->format('Y-m-d H:i') . "\n";
                    } else {
                ...
                try {
                    if (null != $trainee->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ->setTo($trainee->getEmail(), $trainee->getFullname())
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:trainee.notif.' . 'timeCredit15d.html.twig', $mvars), 'text/html');
                ...
                try {
                    if (null != $trainee->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ->setTo($trainee->getEmail(), $trainee->getFullname())
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:trainee.notif.' . 'timeCredit30d.html.twig', $mvars), 'text/html');
                ...
                try {
                    if (null != $trainee->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ->setTo($trainee->getEmail(), $trainee->getFullname())
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:trainee.notif.timeCreditSB.html.twig', $mvars), 'text/html');
                ...
                try {
                    if (null != $trainee->getEmail()) {
                        ...
                        $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                            ->setTo($trainee->getEmail(), $trainee->getFullname())
                            ->setSubject($subject)
                            ->setBody($templating->render('IlcfranceWorldspeakSharedResBundle:Mail:trainee.notif.timeCreditSE.html.twig', $mvars), 'text/html');
