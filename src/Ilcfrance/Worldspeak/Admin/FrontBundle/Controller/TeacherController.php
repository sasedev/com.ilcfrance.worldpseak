...
class TeacherController extends BaseController
{
     ...
     * @return RedirectResponse|Response
     */
    public function availabilitiesAction(Request $request, $year = null, $week = null)
    {
     ...
     */
    public function registerMailAction(Request $request, $id)
    {
        $em = $this->getEntityManager();
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
     ...
     * @return RedirectResponse
     */
    public function newPassMailAction(Request $request, $id)
    {
        $em = $this->getEntityManager();
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            ...
            if (null == $teacher) {
                ...
                if (null != $teacher->getEmail() && trim($teacher->getEmail()) != '') {
                    ...
                    $message = Swift_Message::newInstance()->setFrom($from, $fromName)
                        ->setTo($teacher->getEmail(), $teacher->getFullname())
                        ->setSubject($subject)
                        ->setBody($this->renderView('IlcfranceWorldspeakSharedResBundle:Mail:teacher.newpass.html.twig', $mvars), 'text/html');
     ...
     * @return RedirectResponse|Response
     */
    public function planningAction(Request $request, $id, $year = null, $week = null)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
     ...
     * @return RedirectResponse|Response
     */
    public function logsAction(Request $request, $id, $page)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Admin__teacher_list');
     ...
     * @return RedirectResponse
     */
    public function logDeleteAction(Request $request, $id)
    {
        $urlFrom = $this->getReferer($request);
        if (null == $urlFrom || trim($urlFrom) == '') {
            $urlFrom = $this->generateUrl('Admin__teacher_list');
